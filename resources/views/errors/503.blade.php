@component('errors.layout', [
    ...
    'description' => isset($exception) && $exception->getMessage() ? $exception->getMessage() : 'Le service est temporairement indisponible. Veuillez réessayer dans quelques instants.',
])
    @slot('icon')
