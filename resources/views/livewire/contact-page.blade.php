<div>
    <!-- Page header -->
    <div class="relative bg-accent-50 border-b border-gray-100 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="text-3xl sm:text-4xl font-bold text-accent-700">Contactez-nous</h1>
            <p class="text-accent-500 mt-2">Notre équipe vous répond sous 24 heures ouvrées.</p>
        </div>
    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm text-gray-600">
                        <li class="flex items-start gap-3">
                            <div class="w-9 h-9 bg-brand-50 rounded-xl flex items-center justify-center shrink-0 mt-0.5">
