...
<style>
  ...
  .btn{display:inline-block;background:{{ $btnColor ?? '#1a7a4a' }};color:#fff!important;text-decoration:none;padding:13px 28px;border-radius:8px;font-weight:600;font-size:14px;margin:8px 0}
